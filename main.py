...
bot = telebot.TeleBot("6065126500:AAFZbXmXzSJFY3Ghur2qoua3cI0xNweEr_g")
    ...
    try:
        if call.message:
            if call.data == 'one':
                ...
                bot.send_message(user['id'][user['name'].index(user_name)], 'https://t.me/+0usKUCCWU8FiN2My')
